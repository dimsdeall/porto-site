...
function Header({ onScroll }: HeaderProps) {
  ...
  return (
    <div ref={ref} className="px-2 md:px-8 h-auto pt-0 sm:pt-5 md:pt-10">
      <section
      ...
      >
        <div className="order-last md:order-first lg:col-span-2 flex flex-col gap gap-y-4 justify-center">
          ...
          <div className="flex flex-row items-center gap-x-2 text-info font-extrabold hover:text-blue justify-center md:justify-normal">
            <SiGitlab />
            <a
